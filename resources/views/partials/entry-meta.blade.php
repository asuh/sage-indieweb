...
@if ( 'post' === get_post_type() )
  @if ( taxonomy_exists( 'series' ) && get_the_term_list( get_the_ID(), 'series', '', _x( ', ', 'Used between list items, there is a space after the comma.', 'sage' ) ) )
    <span class="series-links">
      <span class="screen-reader-text">
        {{ _x( 'Series', 'Used before series names.', 'sage' ) }}
      </span>
      {!! get_the_term_list( get_the_ID(), 'series', '', _x( ', ', 'Used between list items, there is a space after the comma.', 'sage' ) ) !!}
    </span>
  @endif

  @if ( is_singular() && get_the_tag_list( '', _x( ', ', 'Used between list items, there is a space after the comma.', 'sage' ) ) )
    <div class="tags-links">
      {{ _x( 'Tags:', 'Used before tag names.', 'sage' ) }}
      {!! get_the_tag_list( '', _x( ', ', 'Used between list items, there is a space after the comma.', 'sage' ) ) !!}
    </div>
  @endif
@endif
