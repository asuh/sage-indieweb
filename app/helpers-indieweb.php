...
function indieweb_single_author_site() {
	if ( ! is_multi_author() && class_exists( 'IndieWeb_Plugin' ) ) {
		...
		printf( '<span class="byline"><span class="author vcard h-card"><a href="%3$s" class="url u-url">%1$s</a><div class="screen-reader-text">%2$s </div> <a class="url fn n u-url" href="%3$s">%4$s</a></span></span>',
...
function sage_entry_meta() {
	if ( 'post' === get_post_type() ) {
		if ( is_multi_author() && ! is_singular() ) {
			$author_avatar_size = apply_filters( 'sage_author_avatar_size', 49 );
			printf( '<span class="byline"><span class="author vcard h-card">%1$s<div class="screen-reader-text">%2$s </div> <a class="url fn n u-url" href="%3$s">%4$s</a></span></span>',
